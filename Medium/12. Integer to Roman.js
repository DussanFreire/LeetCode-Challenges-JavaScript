...
var intToRoman = function (num) {
    const thousandsPart = ROMAN_THOUSANDS[Math.floor(num / 1000)];
    const hundredsPart = ROMAN_HUNDREDS[Math.floor((num % 1000) / 100)];
    const tensPart = ROMAN_TENS[Math.floor((num % 100) / 10)];
    const onesPart = ROMAN_ONES[num % 10];
